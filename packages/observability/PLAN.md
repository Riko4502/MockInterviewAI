...
### 0.7.10 — 2026-09-18
- **HTTP-учёт (apps/api):** `MetricsInterceptor` → `MetricsMiddleware`: guards
  выполняются раньше interceptors, и отклонённые запросы (401/403/429) не
  учитывались бы. Добавлен `metrics.middleware.spec.ts`.
