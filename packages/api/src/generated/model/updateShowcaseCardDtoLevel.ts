...
export type UpdateShowcaseCardDtoLevel = typeof UpdateShowcaseCardDtoLevel[keyof typeof UpdateShowcaseCardDtoLevel];


export const UpdateShowcaseCardDtoLevel = {
  JUNIOR: 'JUNIOR',
  MIDDLE: 'MIDDLE',
  SENIOR: 'SENIOR',
  LEAD: 'LEAD',
