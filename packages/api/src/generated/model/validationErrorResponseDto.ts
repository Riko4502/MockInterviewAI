 ...
 */
import type { ValidationErrorResponseDtoMessage } from './validationErrorResponseDtoMessage';

export interface ValidationErrorResponseDto {
  statusCode: number;
  /** Карта ошибок `{ field: message }`. */
  message: ValidationErrorResponseDtoMessage;
}
