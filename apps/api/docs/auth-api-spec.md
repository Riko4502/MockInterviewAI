...
Карта тестов приведена в `apps/api/docs/auth-api-plan.md`, Phase 6 «Тестирование».
...
- Соответствие проверяется в code review (biome по умолчанию не требует JSDoc); в `auth-api-plan.md`, Phase 6, зафиксирован чек-пункт.
...
- План реализации: `apps/api/docs/auth-api-plan.md`.
