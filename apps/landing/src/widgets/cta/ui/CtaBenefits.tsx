...
export function CtaBenefits() {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 text-xs sm:text-sm text-muted-foreground font-medium border-t border-border dark:border-white/10 pt-8 max-w-2xl mx-auto">
