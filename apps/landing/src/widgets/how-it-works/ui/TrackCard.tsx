...
export function TrackCard({
  ...
  return (
    <Card
      onClick={onClick}
      className={cn(
        "p-4 rounded-2xl flex flex-col justify-between transition-colors duration-200 text-left cursor-pointer group select-none relative overflow-hidden backdrop-blur-xl shadow-none min-h-[138px] border",
        selected
    ...
    >
      <Card.Header className="p-0 space-y-1.5 min-w-0">
        <div className="flex items-center gap-2">
          ...
          <Card.Title className="text-sm font-bold text-foreground truncate">
            {title}
          </Card.Title>
        </div>
        <Card.Description
      ...
      <Card.Footer className="mt-3.5 pt-3 px-0 pb-0 border-t border-black/[0.06] dark:border-white/[0.08] flex items-center justify-between text-[11px] font-mono h-[34px]">
